...
This Privacy Policy applies to the Scroll Exit mobile application, provided by Scroll Exit. The Application is offered as a free service and is intended for use as is.

1. Information Collection & Use

Scroll Exit does not require creating an account and does not upload, sell, share, or transfer personal data to external servers. All usage data is stored locally on your device.

The Application may request permission to access certain features of your device for functionality purposes, including:
	•	HealthKit (optional)  used to read and/or write Mindful Minutes data. No health data leaves your device.
	•	Local Notifications (optional)  used to send reminders if enabled by the user.
